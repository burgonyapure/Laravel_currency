    ...
    <div class="container">  
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" v-for="valto in valtok" :key="valto.name">
                    <a class="nav-link" @click="loadValto(valto)" :id="valto.name +'-tab'" data-toggle="tab" :href="'#'+valto.name" role="tab" :aria-controls="valto.name" aria-selected="true">{{valto.name}}</a>
                </li>
            </ul>
            
            <div class="tab-content" id="myTabContent">
                <div v-for="valto in valtok" :key="valto.name" class="tab-pane fade show" :id="valto.name" role="tabpanel" :aria-labelledby="valto.name+'-tab'">
